...
const baskan = new Discord.MessageEmbed()
       .setAuthor(`YılmazBOT - Çekiliş`)
       .setTitle(`<a:dia:791601411397648434> **Botta Toplam ${client.commands.size} Komut Bulunuyor**`)
       .setDescription(`
<a:ok:791600953606012939> **y!bitir <Çekiliş ID> : **ID'sini Yazdığınız Çekilişi Bitirir.
<a:ok:791600953606012939> **y!iptal <Çekiliş ID> : **ID'sini Yazsığınız Çekilişi İptal Eder.
<a:ok:791600953606012939> **y!yeniden <Çekiliş ID> : **ID'sini Yazdığınız Çekilişi Yeniden Çeker.
<a:ok:791600953606012939> **y!çekiliş <süre kazanansayı ödül> : **Belirttiğiniz Şekilde Çekiliş Yaparsınız. 
       `)
