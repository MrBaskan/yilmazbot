...
const baskan = new Discord.MessageEmbed()
       .setAuthor(`YılmazBOT - Sayaç Sistemi`)
       .setTitle(`<a:dia:791601411397648434> **Botta Toplam ${client.commands.size} Komut Bulunuyor**`)
       .setDescription(`
<a:ok:791600953606012939> **y!sayaç <#kanal sayı> : **Sunucu Sayacını Ayarlarsınız.
<a:ok:791600953606012939> **y!sayaç-sıfırla : **Sunucu Sayacını Sıfırlarsınız.
       `)
