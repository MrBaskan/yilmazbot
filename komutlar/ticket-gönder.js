  ...
  if (args[0] === "gönder") {
    ...
    if (!kanalbelirle)
      return message.channel.send(
        `Ticketi göndereceğim kanalı ayarlamamışsın: y!ticket-kanal ayarla #channel`
      );
    client.channels
      .cache.get(kanalbelirle)
      .send(
        new Discord.MessageEmbed()
          .setTitle(`YılmazBOT Ticket Tool`)
          .setFooter(`YılmazBOT Ticket Tool`, client.user.avatarURL())
          .setColor("GREEN")
