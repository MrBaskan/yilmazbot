...
module.exports.run = async (client, message, args) => {
  ...
  if (!sea) return message.channel.send('Oylama kanalı ayarlanmamış. Ayarlamak için `y!oylama-kanal #kanal`')
    ...
    .setColor("BLACK")
    .addField('Oylamaya Katılmayı Unutmayın',`**${yazi}**`)
    .setAuthor(`BaşkanBot Oylama Sistemi`)
    .setThumbnail(``)
