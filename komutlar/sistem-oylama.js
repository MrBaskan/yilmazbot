...
const baskan = new Discord.MessageEmbed()
       .setAuthor(`YılmazBOT - Oylama Sistemi`)
       .setTitle(`<a:dia:791601411397648434> **Botta Toplam ${client.commands.size} Komut Bulunuyor**`)
       .setDescription(`
<a:ok:791600953606012939> **y!oylama-kanal <#kanal> : **Oylama Kanalını Ayarlarsınız.
<a:ok:791600953606012939> **y!oylama <yazı> : **Oylama Kanalına Oylama Atar.
       `)
