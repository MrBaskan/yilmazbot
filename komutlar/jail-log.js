...
if (!message.member.hasPermission('MANAGE_GUILD')) return message.reply(`**y!jail-log ayarla/sıfırla** isimli komutu kullanabilmek için \`SUNUCUYU YÖNET\` yetkisine sahip olman gerekiyor.`)
if (!args[0]) return message.reply(`Sistemi kullanabilmek için, y!jail-log ayarla/sıfırla @rol yazmalısın.`)
  if (args[0] == 'ayarla') {
