...
const baskan = new Discord.MessageEmbed()
       .setAuthor(`YılmazBOT - Modlog Sistemi`)
       .setTitle(`<a:dia:791601411397648434> **Botta Toplam ${client.commands.size} Komut Bulunuyor**`)
       .setDescription(`
<a:ok:791600953606012939> **y!mod-log <#kanal> : **ModLog Kanalını Ayarlarsınız.
<a:ok:791600953606012939> **y!mod-log sıfırla : **ModLog Kanalını Sıfırlarsınız.
      `)
