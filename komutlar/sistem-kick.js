...
const baskan = new Discord.MessageEmbed()
       .setAuthor(`YılmazBOT - Kick Sistemi`)
       .setTitle(`<a:dia:791601411397648434> **Botta Toplam ${client.commands.size} Komut Bulunuyor**`)
       .setDescription(`
<a:ok:791600953606012939> **y!kick-log <#kanal> : **Kick Log Kanalını Ayarlarsınız.
<a:ok:791600953606012939> **y!kick-yetkili <@rol> : **Kick Yetkilisini Belirlersiniz.
<a:ok:791600953606012939> **y!kick <@kullanıcı sebep> : **Belirttiğiniz Kullanıcıyı Kicklersiniz.
       `)
