...
const baskan = new Discord.MessageEmbed()
       .setAuthor(`YılmazBOT - İstek Sistemi`)
       .setTitle(`<a:dia:791601411397648434> **Botta Toplam ${client.commands.size} Komut Bulunuyor**`)
       .setDescription(`
<a:ok:791600953606012939> **y!istek-kanal ayarla <#kanal> : **İstek Kanalını Ayarlarsınız.
<a:ok:791600953606012939> **y!istek-kanal sıfırla : **İstek Kanalını Sıfırlarsınız.
<a:ok:791600953606012939> **y!istek <istek> : **İsteğinizi Bildirirsiniz.
       `)
